            ...
            foreach ($table_rate as $key => $value) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url() ?>commercial/table_rate_domestic_delete_process/<?php echo $value['id'] ?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are You Sure?')"><i class="fas fa-trash m-0"></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
...
<script>
    ...
    $("#formDataDomestic").submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>commercial/table_rate_domestic_create_process",
