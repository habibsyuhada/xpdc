                  ...
                  <tbody>
                    <?php foreach ($list as $key => $value) : ?>
                      <tr>
                        ...
                        <td>
                          <a target="_blank" onclick="show_modal('<?= $value['id'] ?>')" class="btn btn-success" title="Arrived"><i class="fas fa-truck-pickup m-0"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="serviceModalLabel">Arrived</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?= base_url() ?>operation/arrived_process_db" method="POST">
